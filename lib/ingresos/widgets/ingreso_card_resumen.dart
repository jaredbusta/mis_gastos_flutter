...
class IngresoCardResumen extends StatelessWidget {
  double total_gasto;
  int cantidad_items;
  IngresoCardResumen({
    Key? key,
  ...
  Card gastoCard(BuildContext context) {
    ...
    return new Card(
      ...
      child: Stack(
        children: [
          GradientBack(
              title: " ", height: 110, color1: "#CFCFCF", color2: "#F3F3F3"),
          Column(
